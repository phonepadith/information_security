...
class FaceBoom(object):
    ...
    def login(self,target, password):
        ...
        try:
            self.br.open("https://www.edlhris.com.la")
...
OPTIONS:
       |
    |--------
    | -t <target email> [OR] <TARGET ID>    ::> Specify target Email [OR] Target Profile ID
    |--------
    ...
    |--------
    | -g <TARGET TARGET Profile URL>        ::> Specify Target TARGET Profile URL For Get HIS ID
    |--------
...
Examples:
     ...
     |--------
     | python faceboom.py -g https://www.test-brute-force.com
     |--------
""")
...
def Main():
   ...
   parse.add_option("-g","-G","--getid","--GETID",dest="url",type="string",
                        help="Specify TARGET TARGET PROFILE URL to get his ID")
